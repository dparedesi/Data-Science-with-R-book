...
knitr::include_graphics(file.path(img_path, "04-statistics", "monty-hall-cerradas.png"))
```
</div>
...
knitr::include_graphics(file.path(img_path, "04-statistics", "monty-hall-abierta.png"))
```
</div>
