...
```{r, echo=FALSE}
knitr::include_graphics(file.path(img_path,"multidisciplinaria.png"))
```
...
```{r, echo=FALSE}
knitr::include_graphics(file.path(img_path,"CRAN-google.png"))
```

2. Once on the CRAN page, select the version for your operating system: Linux, Mac OS X, or Windows:

```{r, echo=FALSE}
knitr::include_graphics(file.path(img_path,"CRAN-website.png"))
```
...
```{r, echo=FALSE}
knitr::include_graphics(file.path(img_path,"CRAN-windows.png"))
```

4. Click on the first link to get the most recent version:

```{r, echo=FALSE}
knitr::include_graphics(file.path(img_path,"CRAN-64-bits.png"))
```
...
```{r, echo=FALSE}
knitr::include_graphics(file.path(img_path,"rstudio-website-2.png"))
```
...
```{r, echo=FALSE}
knitr::include_graphics(file.path(img_path,"VirtualBox_Windows-7-Enterprise_22_03_2018_16_21_16.png"))
```
...
```{r, echo=FALSE}
knitr::include_graphics(file.path(img_path,"VirtualBox_Windows-7-Enterprise_22_03_2018_16_21_42.png"))
```
