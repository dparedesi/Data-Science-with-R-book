...
`r ne`. Access the **Uber Peru 2010** dataset from [this link](https://dparedesi.github.io/DS-with-R-datasets/uber-peru-2010.csv) and attempt to import it into an object named `uber_peru_2010`. Pay attention to the delimiters used in the file.
...
`r ne`. Download the resource file from [this link](https://dparedesi.github.io/DS-with-R-datasets/resources-other-idd.xlsx) to a temporary location. Validating that the file exists, load the specific sheet named "Deflators" into an object named `data`.
