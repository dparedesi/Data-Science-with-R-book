...
<div align="center">
```{r, echo=FALSE, fig.alt="Vicinitas.io interface for downloading user tweets from Twitter"}
knitr::include_graphics(file.path(img_path, "05-wrangling", "download-user-tweets.png"))
```
</div>
